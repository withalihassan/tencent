 ...
 * @method string getUrl() Obtain The playlist playback url.
 * @method void setUrl(string $Url) Set The playlist playback url.
...
class CreateRoundPlayResponse extends AbstractModel
{
    ...
    /**
     * @var string The playlist playback url.
     */
    public $Url;
     ...
     * @param string $Url The playlist playback url.
